                            ...
                            <div className='contact-us-card grid grid-cols-2 w-full p-10 bg-gray-50 my-10 bg-opacity-25 rounded-lg text-gray-700 shadow-2xl'>
                                ...
                                <div className='p-4'>
                                    ...
                                    <ul className='flex gap-6 items-center justify-center text-5xl py-10'>
                                        <li><a rel='noreferrer' href="https://www.instagram.com" target='_blank'><img type='social-media-links' src="" alt="" className='transform hover:scale-110 transition-transform ease-in-out duration-150 fa-brands fa-instagram hover:text-red-600' /></a></li>
                                        <li><a rel='noreferrer' href="https://www.linkedin.com" target='_blank'><img type='social-media-links' src="" alt="" className='transform hover:scale-110 transition-transform ease-in-out duration-150 fa-brands fa-linkedin hover:text-blue-500' /></a></li>
                                        <li><a rel='noreferrer' href="https://www.github.com" target='_blank'><img type='social-media-links' src="" alt="" className='transform hover:scale-110 transition-transform ease-in-out duration-150 fa-brands fa-github hover:text-black' /></a></li>
                                        <li><a rel='noreferrer' href="https://www.twitter.com" target='_blank'><img type='social-media-links' src="" alt="" className='transform hover:scale-110 transition-transform ease-in-out duration-150 fa-brands fa-x-twitter  hover:text-black' /></a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
